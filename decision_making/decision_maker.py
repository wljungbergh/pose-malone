...
class Decision_maker:
    ...
    def add_head_angles(self, new_head_angle):
    ...
    def check_head_angle(self):
        relative_angles = self.head_angles[0]-self.head_angles_ref
        off_angle = np.sqrt(relative_angles[0]**2 + relative_angles[1]**2)
