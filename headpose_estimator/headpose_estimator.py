...
class HeadPoseEstimator:
    ...
    def estimate_headpose(self, face, render = False):
        faces[0,:,:,:] = cv2.resize(face, (img_size, img_size))
...
def main():
    ...
    protoPath = os.path.sep.join([model_file_location, 'demo', "face_detector", "deploy.prototxt"])
    modelPath = os.path.sep.join([model_file_location, 'demo', "face_detector",
